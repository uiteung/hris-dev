...
function fetchDataById(id) {
  const url = `https://hris_backend.ulbi.ac.id/api/v2/honour/assessment/byid?id=${id}`;
  fetch(url, {
    method: "GET",
    headers: {
...
function updateData() {
  ...
  const url = `https://hris_backend.ulbi.ac.id/api/v2/honour/assessment/update?_id=${id}`;
